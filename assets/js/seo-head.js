    ...
    const PAGES = {
        ...
        '/pages/jogi.html': {
            ...
            faq: [
                    ...
                    { q: 'Tárol-e a tm3.hu személyes adatokat?', a: 'A tm3.hu csak a böngésződ localStorage-jában tárol felhasználói adatokat (fogyasztási bejegyzések, TCO-számítások, vásárlási checklist), amelyek kizárólag a te eszközödön maradnak, és soha nem kerülnek továbbításra. A Google Analytics 4 statisztikai sütiket kizárólag a te kifejezett, a láblécben vagy a bannerben megadott hozzájárulásod után használ — anonimizált IP-vel, a Google adatkezelési szabályai szerint. A részleteket és a hozzájárulás visszavonásának módját a <a href="/pages/jogi.html">Jogi tudnivalók</a> / IV. Cookie tájékoztató tartalmazza.' },
